...
export default class CourseValidator{
  ...
  public async validateEmail(ctx : HttpContextContract){
    ...
    public async validateCourseSchema(ctx : HttpContextContract){
    ...
    public async validateCreateCourseSchema(ctx : HttpContextContract){
