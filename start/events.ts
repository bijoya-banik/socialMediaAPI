...
Event.on('delete:notification', 'NotificationListener.deleteNotification')
Event.on('delete:commentNotification', 'NotificationListener.deleteCommentNotification')
Event.on('delete:friendCount', 'NotificationListener.deleteFriendCount')
